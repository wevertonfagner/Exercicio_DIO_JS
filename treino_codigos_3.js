...
const nTomadas = function (t1, t2, t3, t4) {
    return (t1 + t2 + t3 + t4)
}

const totalTomadas = nTomadas(2,4,3,2) - 3 // se cada linha de tomada precisa utilizar uma tomada da linha anterior. Então tenho 4 linhas de tomadas, as três anteriores terão uma tomada ocupada para a próxima linha
